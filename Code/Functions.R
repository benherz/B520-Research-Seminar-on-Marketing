...
noise_simulation <- function(N, T, n_treated, treatment_period) {
...
### Function with mean-zero innovations, linear time trend and treatment effect
treatment_simulation <- function(N, T, n_treated, treatment_period, control_trend,
